...
import com.ultikits.plugins.cleaner.i18n.UltiCleanerLanguageCatalogueTest.Catalogue;
 ...
 * ({@link UltiCleanerLanguageCatalogueTest#loadModuleCatalogues()}: the framework's own {@link Language},
...
public final class CatalogueText {
    ...
    public static Map<String, String> entries(String code) {
        try {
            for (Catalogue c : UltiCleanerLanguageCatalogueTest.loadModuleCatalogues()) {
